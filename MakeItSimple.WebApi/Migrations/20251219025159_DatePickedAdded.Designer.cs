...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20251219025159_DatePickedAdded")]
    partial class DatePickedAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.Phase_One.CategoryConcernSetup.CategoryConcernChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_category_concern_channels");

                    b.HasIndex("CategoryConcernId")
                        .HasDatabaseName("ix_category_concern_channels_category_concern_id");

                    b.HasIndex("ChannelId")
                        .HasDatabaseName("ix_category_concern_channels_channel_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.Phase_One.CategoryConcernSetup.CategoryConcernChannel", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.Phase_One.CategoryConcernSetup.CategoryConcern", "CategoryConcern")
                        .WithMany("CategoryConcernChannels")
                        .HasForeignKey("CategoryConcernId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_category_concern_channels_category_concerns_category_concern_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", "Channel")
                        .WithMany()
                        .HasForeignKey("ChannelId")
                        .HasConstraintName("fk_category_concern_channels_channels_channel_id");

                    b.Navigation("CategoryConcern");
